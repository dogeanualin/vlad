...
# Route for showing tables
@app.route('/tables/<database>')
def show_tables(database):
    # Fetch the table names from the database
    tables = fetch_table_names(database)

    return render_template('tables.html', database=database, tables=tables)

# Route for showing table columns
# Route for showing table columns
...
def show_table_columns(database, table_name):
    ...
    return render_template('columns.html', database=database, table_name=table_name, columns=columns)
