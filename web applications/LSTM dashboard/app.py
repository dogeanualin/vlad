...
sales_ts1 = pd.Series(df['product_sales'].values, index=df.index)
sales_ts2 = pd.Series(df['sales_per_week'].values, index=df.index)
sales_ts3 = pd.Series(df['sales_per_day'].values, index=df.index)
